package org.test;
	...
	public class MobileValidation1 {
		...
		@Test
		public void method3() {
			WebElement mobileName = driver.findElement(By.xpath("(//div[contains(text(), 'REDMI 9i Sport')])[1]"));
		...
		@Test
		public void method5() {
			WebElement mobileName2 = driver.findElement(By.xpath("//span[contains(text(),'REDMI')]"));
